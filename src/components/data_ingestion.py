...
class DataIngestion:
    ...
    #in above function we write code for reading the data from source and then we will split the data into train and test and then we will save it to the respective path
